...
export default function DessertSection({ entries, onChange }) {
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <button
        onClick={add}
        className="w-full py-3 rounded-xl border-2 border-dashed border-pink-300 text-pink-600 text-sm font-medium active:bg-pink-50 transition-colors"
      >
        + Add dessert
      </button>
    </div>
